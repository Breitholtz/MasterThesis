...
## act is the gradients and img is the image data
 ...
 # print normgrad[indices[0,10000,0],indices[0,10000,1]]
  ...
  sample=random.sample(indices[0],k=int(L2))
  #print sample[0][1]
# make the important pixels be greyed out
  for i in range(0,int(L2-1)):
   # take L2 random points from the indices and grey those out
      newimg[sample[i][0],sample[i][1]]=MEAN
